    ...
    do {
        ...
        switch (userChoice) {
            ...
            case 3:
                ...
                // Print k_m to console
                break;
            case 4:
                calc_prod(m1, m2, prod);
                // Print prod to console
                break;
            case 5: 
                calc_inv(m1, m_inv);
                // Print m_inv to console
                break;
            default:
                break;
        }
...
void print_matrix(fstream &outfile, string name, Matrix m) {
    ...
    outfile << string(nameLength, ' ') << string(3, ' ') << setw(7) << m.a11 << setw(7) << m.a12 << endl;
    outfile << name << " = " << endl;
    outfile << string(nameLength, ' ') << string(3, ' ') << setw(7) << m.a21 << setw(7) << m.a22 << endl << endl;
}
